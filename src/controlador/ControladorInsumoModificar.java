 ...
 * @author ginot
 */
public class ControladorInsumoModificar {
        //private Vista vista;
    InsumoModificar vista;
    private InsumosMedicos modelo;
      
    public ControladorInsumoModificar(InsumoModificar v, InsumosMedicos m)
    {
        this.vista = v;
        this.modelo = m;        
    }
...
//                                          this.modelo.getAreaNombreById(this.modelo.getAreaNombreById());
        this.vista.cargarArea(AreasMedicas, this.modelo.getAreaNombreById(this.modelo.getId()) );
        
        this.vista.setearInsumo(modelo.getInsumosMedicos(modelo));
...
//                 cantidad = Float.parseFloat(c);      
             try{
                 ...
                 JOptionPane.showMessageDialog(null, "no se adminte texto en este campo");
             }
